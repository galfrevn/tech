...
export default function Home() {
  ...
  return (
    <AnimatedSection>
      ...
      <AnimatedItem className='flex items-center gap-4 mb-8'>
      ...
      <AnimatedItem className='flex space-x-2 items-center mt-8 mb-8'>
      ...
      <AnimatedItem className='prose prose-neutral dark:prose-invert my-8'>
      ...
      <AnimatedItem className='prose prose-neutral dark:prose-invert mt-8'>
      ...
      <AnimatedItem className='-mt-[40px] -mb-[160px] flex items-center justify-center w-full'>
        <Donut />
      </AnimatedItem>
    </AnimatedSection>
  );
